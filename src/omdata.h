...
struct oter_type_t {
    ...
    public:
        ...
        enum class see_costs : uint8_t {
            pit, // no cost to see through, _and_ can see down through it
            flat, // no cost to see through
            brush, // 0.3
            fence, // 0.4
            forest, // 0.75
            buildings, // 0.9
        ...
        see_costs see_cost = see_costs::flat;     // Affects how far the player can see in the overmap
